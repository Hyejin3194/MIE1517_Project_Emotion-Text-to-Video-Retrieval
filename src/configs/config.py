...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config for pretraining and finetuning"):
        ...
        parser.add_argument("--is_demo", action='store_true', help="is this for demo or not")
        parser.add_argument("--query", type=str, default=None)
        parser.add_argument("--is_embed", action='store_true', help="To use emotion embedding model or not")
